...
byreview_df = main_df.groupby(by="review_score")["review_id"].nunique().reset_index()
...
counts = main_df['review_score'].value_counts()
...
sales_by_year = main_df['year'].value_counts().sort_index()
